...
export default function ProfilePage() {
    ...
    const [profileImage, setProfileImage] = useState("https://ui-avatars.com/api/?name=Jean+Dupont&background=0D8ABC&color=fff&size=128");

    const [profileData, setProfileData] = useState({
        prenom: 'Mamadou',
        nom: 'Dieng',
        email: 'mamadou.dieng@example.com',
        phone: '+222 34 56 78 90',
        dob: '1995-08-15',
        location: 'Nouakchott, Mauritanie',
        bio: 'Passionné par l\'apprentissage et le développement continu. Toujours en quête de nouvelles formations pour améliorer mes compétences.',
        loisir: 'Photographie, Randonnée, Lecture',
        statut: 'Apprenant'
    });
                            ...
                            <div className="w-full md:w-1/3 xl:w-1/4">
                                <div className="bg-slate-50 border border-slate-200 shadow-sm rounded-2xl p-6 flex flex-col items-center sticky top-28">
                                    ...
                                    <label className="relative group cursor-pointer mb-5 block">
                                        <div className="w-32 h-32 rounded-full overflow-hidden border-4 border-white shadow-md bg-slate-200 relative">
                                    ...
                                    <h2 className="text-[18px] font-bold text-slate-900 text-center">{profileData.prenom} {profileData.nom}</h2>
                                    ...
                                    <div className="w-full mt-8 space-y-4 pt-6 border-t border-slate-200">
                                        ...
                                        <div className="flex items-center text-[13px] font-medium text-slate-600">
                                            ...
                                            <span className="truncate">{profileData.location || "Non renseigné"}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-6">
                                            ...
                                            <div>
                                                ...
                                                <div className="relative">
                                                    ...
                                                    <input type="date" name="dob" value={profileData.dob} onChange={handleChange} className="w-full pl-10 pr-3 py-2.5 bg-white border border-slate-200 rounded-lg text-sm shadow-sm focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 font-medium text-slate-800" />
                                                </div>
                                            </div>
                                            ...
                                            <div>
                                                ...
                                                <div className="relative">
                                                    ...
                                                    <input type="text" name="location" value={profileData.location} onChange={handleChange} className="w-full pl-10 pr-3 py-2.5 bg-white border border-slate-200 rounded-lg text-sm shadow-sm placeholder-slate-400 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 font-medium text-slate-800" placeholder="Ville, Pays" />
                                                </div>
                                            </div>
                                            ...
                                            <div>
                                                ...
                                                <div className="relative">
                                                    ...
                                                    <select name="statut" value={profileData.statut} onChange={handleChange} className="w-full pl-10 pr-3 py-2.5 bg-white border border-slate-200 rounded-lg text-sm shadow-sm focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 font-medium text-slate-800 appearance-none">
