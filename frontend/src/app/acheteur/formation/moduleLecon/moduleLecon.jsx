        ...
        const loadFormation = async () => {
            try {
                ...
                const formattedFormation = {
                    ...
                    image: data.image ? (data.image.startsWith('http') || data.image.startsWith('/') || data.image.startsWith('data:') ? data.image : `${process.env.NEXT_PUBLIC_API_URL}/uploads/${data.image}`) : null,
                    ...
                    avatar: data.trainer?.avatar ? (data.trainer.avatar.startsWith('http') || data.trainer.avatar.startsWith('data:') ? data.trainer.avatar : `${process.env.NEXT_PUBLIC_API_URL}${data.trainer.avatar}`) : null,
