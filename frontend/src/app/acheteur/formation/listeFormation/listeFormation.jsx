                        ...
                        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-10 pb-6 border-b border-slate-100">
                            <div className="flex-1 w-full max-w-xl">
                                ...
                                <p className="text-slate-500 mt-2 font-medium">
                                    Trouvez la formation idéale pour booster vos compétences.
                                </p>
                            </div>
                            ...
                            <div className="flex flex-wrap items-center gap-2 bg-slate-50 p-1.5 rounded-xl border border-slate-200 shadow-sm w-fit">
                                {[
                                    { key: 'tous', label: 'Tous', icon: <FiFilter className="w-4 h-4" />, activeClass: 'bg-slate-900 text-white shadow-md' },
                                    { key: 'gratuit', label: 'Gratuit', icon: <FiGift className="w-4 h-4" />, activeClass: 'bg-emerald-500 text-white shadow-md shadow-emerald-500/20' },
                                    { key: 'promotion', label: 'Promotions', icon: <FiStar className="w-4 h-4" />, activeClass: 'bg-amber-500 text-white shadow-md shadow-amber-500/20' },
                                    { key: 'normal', label: 'Payant', icon: <FiTag className="w-4 h-4" />, activeClass: 'bg-blue-600 text-white shadow-md shadow-blue-600/20' },
                                ].map(({ key, label, icon, activeClass }) => (
                                    <button
                                        key={key}
                                        onClick={() => setActiveFilter(key)}
                                        className={`px-4 py-2 rounded-lg text-[13px] font-bold transition-all duration-200 flex items-center gap-2 ${activeFilter === key
                                            ? activeClass
